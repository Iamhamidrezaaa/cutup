...
const TEMPLATE_COMPONENTS: Record<EmailTemplateId, TemplateComponent> = {
  ...
  [EMAIL_TEMPLATES.SUBSCRIPTION_EXPIRED]: SubscriptionExpired as TemplateComponent,
  ...
  [EMAIL_TEMPLATES.SUPPORT_TICKET_RESOLVED]: SupportTicketResolved as TemplateComponent,
  ...
  [EMAIL_TEMPLATES.FREE_MP4_EXPORT_ANNOUNCEMENT]:
    FreeMp4ExportAnnouncementEmail as TemplateComponent,
};
