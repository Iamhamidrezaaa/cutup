...
export const API_FEATURE_MAP = {
  ...
  translate: { permission: 'canTranslate', consumesCredit: false },
  subtitles: { permission: 'canTranslate', consumesCredit: false },
  exportTxt: { permission: 'canExportTxt', consumesCredit: false },
  exportDocx: { permission: 'canExportDocx', consumesCredit: false },
  srt: { permission: 'canDownloadSrt', consumesCredit: false },
  subtitles_download: { permission: 'canDownloadSrt', consumesCredit: false },
