...
const PRESETS = {
  ...
  mrBeast: {
    ...
    playResY: 1920,
    uppercase: false,
    layout: { mode: 'stack', wordsPerLineMin: 2, wordsPerLineMax: 3 },
  ...
  aliAbdaal: {
    ...
    playResY: 1920,
    uppercase: false,
    layout: { mode: 'single', wordsPerLineMin: 6, wordsPerLineMax: 12 },
  ...
  luxuryMinimal: {
    ...
    playResY: 1920,
    uppercase: false,
    layout: { mode: 'stack', wordsPerLineMin: 4, wordsPerLineMax: 6 },
  ...
  podcast: {
    ...
    playResY: 1920,
    uppercase: false,
    layout: { mode: 'wide', wordsPerLineMin: 8, wordsPerLineMax: 12 },
  ...
  tiktokNeon: {
    ...
    playResY: 1920,
    uppercase: false,
    layout: { mode: 'stack', wordsPerLineMin: 3, wordsPerLineMax: 5 },
